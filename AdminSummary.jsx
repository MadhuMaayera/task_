    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                ...
                <SummaryCard icon={<FaMoneyBillWave />} text={"Monthly Salary"} number="$1234" color="bg-orange-600" />
            </div>
...
<div className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
                ...
                <SummaryCard icon={<FaCheckCircle/>} text={"Leave Approved"} number={2} color="bg-green-600"/>
                    ...
                    <SummaryCard icon={<FaTimesCircle />} text={"Leave Rejected"} number={1} color="bg-orange-600" />
            </div>
            </div>
            </div>
    )
